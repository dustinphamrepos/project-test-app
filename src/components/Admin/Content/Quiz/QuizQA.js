...
const QuizQA = (props) => {
    ...
    const handleOnChangeQuestion = (type, questionId, value) => {
        ...
        if (index > -1 && type === 'QUESTION') {
            ...
            questionsClone[index].isValidQuestionColor = false
            setQuestions(questionsClone)
        }
    }
            ...
            questionsClone[index].answers = questionsClone[index].answers.map(answer => {
                if (answer.id === answerId) {
                    ...
                    if (type === 'ANSWER') {
                        ...
                        answer.isValidAnswerColor = false
                    }
                }
                return answer
            })
    ...
    const handleSubmitQuestionsForQuiz = async () => {
        ...
        if (isValidAnswer === false) {
            questions[indexQuestionOfAnswer].answers[indexAnswer].isValidAnswerColor = true
        ...
        if (isValidQuestion === false) {
            questions[indexQuestion].isValidQuestionColor = true
                            ...
                            <div key={question.id} className="questions-main mb-4">
                                <div className="questions-content">
                                    <div className="form-floating description">
                                        <input
                                            type="text"
                                            className={`form-control ${question.isValidQuestionColor === true ? "is-invalid" : ""}`}
                                            ...
                                            <div key={answer.id} className="answers-content">
                                                <div className="group-answer">
                                                    ...
                                                    <div className="form-floating answer-name">
                                                        <input
                                                            type="text"
                                                            className={`form-control ${answer.isValidAnswerColor === true ? "is-invalid" : ""}`}
                                                            placeholder="name@example.com"
